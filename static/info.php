...
<div class="banner banner-sub animatedParent animateOnce" style="background-image: url('images/banner-info.jpg');">
    <div class="banner-caption">
        <div class="description animated fadeIn delay-250">
            <p>Discover all the exciting things to do</p>
        </div>
    </div>
...
<!--                    <img src="images/phone.png" class="phone-left">-->
<!--                </div>-->
<!---->
...
<section>
    <div class="section text-center section-join" style="background-image: url('images/banner-home.jpg');">
        <div class="container">
