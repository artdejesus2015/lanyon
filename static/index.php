<?php include 'header.php';?>
        ...
        <div class="banner banner-home animatedParent" style="background-image: url('images/banner-home.jpg');">
            <div class="banner-caption">
                <h1 class="title banner-title animated fadeInDownShort delay-250">Lanyon Live</h1>
                <img class="banner-cap-img animated fadeIn" src="images/Year.png">
                ...
                <div id="carousel-gallery" class="carousel slide carousel-gallery" data-ride="carousel">
                    ...
                    <div class="carousel-inner animated fadeInUpShort" role="listbox" id="links">
                        <div class="item active">
                            <ul>
                                <li>
                                    <a href="images/gallery/gallery1.jpg" title="Gallery1">
                                        <img src="images/gallery/gallery1.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="images/gallery/gallery2.jpg" title="Gallery2">
                                        <img src="images/gallery/gallery2.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="images/gallery/gallery3.jpg" title="Gallery3">
                                        <img src="images/gallery/gallery3.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="images/gallery/gallery4.jpg" title="Gallery3">
                                        <img src="images/gallery/gallery4.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="images/gallery/gallery5.jpg" title="Gallery3">
                                        <img src="images/gallery/gallery5.jpg">
                                    </a>
                                </li>

                                <li>
                                    <a href="images/gallery/gallery6.jpg" title="Gallery3">
                                        <img src="images/gallery/gallery6.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="images/gallery/gallery7.jpg" title="Gallery3">
                                        <img src="images/gallery/gallery7.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="images/gallery/gallery8.jpg" title="Gallery3">
                                        <img src="images/gallery/gallery8.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="images/gallery/gallery9.jpg" title="Gallery3">
                                        <img src="images/gallery/gallery9.jpg">
                                    </a>
                                </li>

                                <li>
                                    <a href="images/gallery/gallery10.jpg" title="Gallery3">
                                        <img src="images/gallery/gallery10.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="images/gallery/gallery11.jpg" title="Gallery3">
                                        <img src="images/gallery/gallery11.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="images/gallery/gallery12.jpg" title="Gallery3">
                                        <img src="images/gallery/gallery12.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="images/gallery/gallery13.jpg" title="Gallery3">
                                        <img src="images/gallery/gallery13.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="images/gallery/gallery14.jpg" title="Gallery3">
                                        <img src="images/gallery/gallery14.jpg">
                                    </a>
                                </li>
                                <li>
                                    <a href="images/gallery/gallery15.jpg" title="Gallery3">
            ...
            <div class="section text-center section-sponsorship animatedParent">
                <div class="container">
                    <div class="diamond-wrap">
                        <img src="images/diamond.png" class="diamond1">

                        <img src="images/diamond-spark.png" class="diamond-spark diamond-spark1">
                        <img src="images/diamond-spark.png" class="diamond-spark diamond-spark2">
                        <img src="images/diamond-spark.png" class="diamond-spark diamond-spark3">
                        <img src="images/diamond-spark.png" class="diamond-spark diamond-spark4">
                        <img src="images/diamond-spark.png" class="diamond-spark diamond-spark5">
        ...
        <section>
            <div class="section text-center section-join animatedParent" style="background-image: url('images/banner-home.jpg');">
                <div class="container">
                    <div class="view-wrapper">
                        ...
                        <div class="join-wrap animated fadeInDownShort">
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="item active">
                                        <div class="item-img" style="background-image: url('images/join-carousel1.jpg')"></div>
                                        <div class="item-caption">
                                            <img src="images/qoute.png" class="qoute-img">
                                            <div class="description">
                        ...
                        <img class="img-join animated fadeIn delay-250" src="images/join-icon.png">
                        <div class="description animated fadeIn delay-500">
