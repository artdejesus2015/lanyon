...
class acf_options_page_plugin
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->settings = array(
			'title' 		=> __('Lanyon Theme','acf'),
			'menu'			=> __('Lanyon Theme','acf'),
			'slug' 			=> 'acf-options',
			'capability'	=> 'edit_posts',
			'pages' 		=> array('Home Page Content', ' Footer Section Content'),
		);
...
//			$parent_page = add_submenu_page( 'nannies', $this->settings['title'], $this->settings['title'], $this->settings['capability'], $this->settings['slug'], array($this, 'html') );
